...
cdef class NFFT:
	...
	property x:
		...
		def __set__(self,np.ndarray[DTYPE_t] x_in):
			'''Set the nodes'''
...
cdef class NNFFT:
	...
	cdef int d, init_type, f_set, fhat_set, x_set
	...
	property v:
		...
		def __set__(self,np.ndarray[DTYPE_t] v_in):
